	...
	const createPost = async (e) => {
		...
		if (tab === 0) {
			...
			const response = await uploadImage(
				"https://api.cloudinary.com/v1_1/ddlez1fo8/image/upload",
				//CLOUDINARY_URL=cloudinary://<your_api_key>:<your_api_secret>@ddlez1fo8
				data,
				header
			);
            ...
            if (!response || !response.data || !response.data.url) {
               throw new Error("Image upload failed or response data missing url");
            }
